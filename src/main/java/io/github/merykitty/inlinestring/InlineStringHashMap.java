 ...
 * @since   1.2
 */
public class InlineStringHashMap<V> implements Map<InlineString.ref,V>, Cloneable {
    /*
     ...
     */
    static class Node<V> implements Map.Entry<InlineString.ref,V> {
        final int hash;
        final InlineString key;
        V value;
        Node<V> next;

        Node(int hash, InlineString key, V value, Node<V> next) {
            this.hash = hash;
            this.key = key;
            this.value = value;
            this.next = next;
        ...
        public final InlineString.ref getKey()        { return key; }
     ...
     */
    static int hash(InlineString key) {
        int h = key.hashCode();
        return (h ^ (h >>> 16));
    }
     ...
     */
    static Class<?> comparableClassFor(InlineString x) {
        return InlineString.class;
    }
     ...
     */
    public InlineStringHashMap(int initialCapacity, float loadFactor) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative.
     */
    public InlineStringHashMap(int initialCapacity) {
     ...
     */
    public InlineStringHashMap(Map<InlineString.ref, ? extends V> m) {
     ...
     */
    final void putMapEntries(Map<? extends InlineString.ref, ? extends V> m, boolean evict) {
        int s = m.size();
        if (s > 0) {
    ...
    public V getPrimitive(InlineString key) {
        Node<V> e;
     ...
     */
    final Node<V> getNode(InlineString key) {
        Node<V>[] tab; Node<V> first, e; int n, hash; InlineString k;
        if ((tab = table) != null && (n = tab.length) > 0 &&
                (first = tab[(n - 1) & (hash = hash(key))]) != null) {
            if (first.hash == hash && // always check first node
                    ((k = first.key).equals(key)))
                return first;
            if ((e = first.next) != null) {
                if (first instanceof TreeNode<V> f)
                    return f.getTreeNode(hash, key);
                do {
                    if (e.hash == hash &&
                            ((k = e.key).equals(key)))
                        return e;
    ...
    public boolean containsKey(InlineString key) {
     ...
     */
    public V putPrimitive(InlineString key, V value) {
    ...
    final V putVal(int hash, InlineString key, V value, boolean onlyIfAbsent,
        ...
        if ((p = tab[i = (n - 1) & hash]) == null)
            ...
            Node<V> e; InlineString k;
            if (p.hash == hash &&
                    ((k = p.key).equals(key)))
                e = p;
            else if (p instanceof TreeNode<V> q)
                e = q.putTreeVal(this, tab, hash, key, value);
            else {
        ...
        if (oldTab != null) {
            for (int j = 0; j < oldCap; ++j) {
                ...
                if ((e = oldTab[j]) != null) {
                    ...
                    else if (e instanceof TreeNode<V> f)
                        f.split(this, newTab, j, oldCap);
                    else { // preserve order
    ...
    public V remove(InlineString key) {
        Node<V> e;
     ...
     * @return the node, or null if none
     */
    final Node<V> removeNode(int hash, InlineString key, Object value,
                             boolean matchValue, boolean movable) {
        Node<V>[] tab; Node<V> p; int n, index;
        if ((tab = table) != null && (n = tab.length) > 0 &&
                (p = tab[index = (n - 1) & hash]) != null) {
            Node<V> node = null, e; InlineString k; V v;
            if (p.hash == hash &&
                    ((k = p.key).equals(key)))
                node = p;
            else if ((e = p.next) != null) {
                if (p instanceof TreeNode<V> q)
                    node = q.getTreeNode(hash, key);
                else {
                    do {
                        if (e.hash == hash &&
                                ((k = e.key).equals(key))) {
            ...
            if (node != null && (!matchValue || (v = node.value) == value ||
                ...
                if (node instanceof TreeNode<V> treeNode)
     ...
     */
    InlineString[] keysToArray(InlineString[] a) {
        var r = a;
        Node<V>[] tab;
        int idx = 0;
    ...
    final class KeySet implements Set<InlineString.ref> {
        ...
        public final void clear()               { InlineStringHashMap.this.clear(); }
        public final Iterator<InlineString.ref> iterator()     { return new InlineStringHashMap.KeyIterator(); }
        ...
        @Override
        public boolean addAll(Collection<? extends InlineString.ref> c) {
            return false;
        }
        ...
        public final Spliterator<InlineString.ref> spliterator() {
            return new InlineStringHashMap.KeySpliterator<>(InlineStringHashMap.this, 0, -1, 0, 0);
        }

        public Object[] toArray() {
            return keysToArray(new InlineString[size]);
        }

        @SuppressWarnings("unchecked")
        public <T> T[] toArray(T[] a) {
            var componentRawType = a.getClass().componentType();
            if (componentRawType == InlineString.class.asValueType()) {
                if (a.length >= size) {
                    return (T[]) keysToArray((InlineString[]) a);
                } else {
                    return (T[]) keysToArray(new InlineString[size]);
                }
            } else {
        ...
        @Override
        public boolean add(InlineString.ref ref) {
            return false;
        }

        public final void forEach(Consumer<? super InlineString.ref> action) {
            Node<V>[] tab;
            if (action == null)
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public final Spliterator<V> spliterator() {
            return new ValueSpliterator<>(InlineStringHashMap.this, 0, -1, 0, 0);
        }
     ...
     */
    public Set<Map.Entry<InlineString.ref,V>> entrySet() {
        Set<Map.Entry<InlineString.ref,V>> es;
        return (es = entrySet) == null ? (entrySet = new EntrySet()) : es;
    }

    final class EntrySet extends AbstractSet<Map.Entry<InlineString.ref,V>> {
        public final int size()                 { return size; }
        public final void clear()               { InlineStringHashMap.this.clear(); }
        public final Iterator<Map.Entry<InlineString.ref,V>> iterator() {
            return new InlineStringHashMap.EntryIterator();
        }
        public final boolean contains(Object o) {
            if (!(o instanceof Map.Entry<?, ?> e))
                return false;
            if (!(e.getKey() instanceof InlineString k))
                return false;
            Node<V> candidate = getNode(k);
            return candidate != null && candidate.equals(e);
        }
        public final boolean remove(Object o) {
            if (o instanceof Map.Entry<?, ?> e
                    && e.getKey() instanceof InlineString k) {
                Object value = e.getValue();
                return removeNode(hash(k), k, value, true, true) != null;
            }
            return false;
        }
        public final Spliterator<Map.Entry<InlineString.ref,V>> spliterator() {
            return new InlineStringHashMap.EntrySpliterator<>(InlineStringHashMap.this, 0, -1, 0, 0);
        }
        public final void forEach(Consumer<? super Map.Entry<InlineString.ref,V>> action) {
            Node<V>[] tab;
            if (action == null)
                throw new NullPointerException();
            if (size > 0 && (tab = table) != null) {
    ...
    public V getOrDefaultPrimitive(InlineString key, V defaultValue) {
        Node<V> e;
    ...
    public V getOrDefault(Object key, V defaultValue) {
        if (key instanceof InlineString k) {
            return getOrDefaultPrimitive(k, defaultValue);
        } else {
            return defaultValue;
        }
    }

    public V putIfAbsent(InlineString key, V value) {
        return putVal(hash(key), key, value, true, true);
    }

    @Override
    public V putIfAbsent(InlineString.ref key, V value) {
        return putIfAbsent((InlineString) key, value);
    }

    public boolean remove(InlineString key, V value) {
    ...
    public boolean remove(Object key, Object value) {
        if (key instanceof InlineString k) {
            return remove(k, (V) value);
        } else {
            return false;
        }
    }

    public boolean replace(InlineString key, V oldValue, V newValue) {
        Node<V> e; V v;
    ...
    public boolean replace(InlineString.ref key, V oldValue, V newValue) {
        return replace((InlineString) key, oldValue, newValue);
    }

    public V replace(InlineString key, V value) {
        Node<V> e;
        if ((e = getNode(key)) != null) {
            V oldValue = e.value;
            e.value = value;
    ...
    public V replace(InlineString.ref key, V value) {
        return replace((InlineString) key, value);
    }

    public V computeIfAbsent(InlineString key,
                             Function<? super InlineString.ref, ? extends V> mappingFunction) {
        ...
        if ((first = tab[i = (n - 1) & hash]) != null) {
            if (first instanceof TreeNode<V> f)
                old = f.getTreeNode(hash, key);
            else {
                Node<V> e = first; InlineString k;
                do {
                    if (e.hash == hash &&
                            ((k = e.key).equals(key))) {
                        old = e;
     ...
     */
    @Override
    public V computeIfAbsent(InlineString.ref key,
                             Function<? super InlineString.ref, ? extends V> mappingFunction) {
        return computeIfAbsent((InlineString) key, mappingFunction);
    }

    public V computeIfPresent(InlineString key,
                              BiFunction<? super InlineString.ref, ? super V, ? extends V> remappingFunction) {
     ...
     */
    @Override
    public V computeIfPresent(InlineString.ref key,
                              BiFunction<? super InlineString.ref, ? super V, ? extends V> remappingFunction) {
        return computeIfPresent((InlineString) key, remappingFunction);
    }

    public V compute(InlineString key,
                     BiFunction<? super InlineString.ref, ? super V, ? extends V> remappingFunction) {
        if (remappingFunction == null)
            throw new NullPointerException();
        int hash = hash(key);
     ...
     */
    @Override
    public V compute(InlineString.ref key,
                     BiFunction<? super InlineString.ref, ? super V, ? extends V> remappingFunction) {
        return compute((InlineString) key, remappingFunction);
    }

    public V merge(InlineString key, V value,
     ...
     */
    @Override
    public V merge(InlineString.ref key, V value,
                   BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
    ...
    @Override
    public Object clone() {
        InlineStringHashMap<V> result;
        try {
            result = (InlineStringHashMap<V>)super.clone();
    ...
    final class KeyIterator extends HashIterator
            implements Iterator<InlineString.ref> {
        public final InlineString.ref next() { return nextNode().key; }
    }
    ...
    final class EntryIterator extends HashIterator
            implements Iterator<Map.Entry<InlineString.ref,V>> {
        public final Map.Entry<InlineString.ref,V> next() { return nextNode(); }
    }
    ...
    static class HashMapSpliterator<V> {
        ...
        HashMapSpliterator(InlineStringHashMap<V> m, int origin,
                           int fence, int est,
    ...
    static final class KeySpliterator<V>
            ...
            implements Spliterator<InlineString.ref> {
        KeySpliterator(InlineStringHashMap<V> m, int origin, int fence, int est,
                       int expectedModCount) {
    ...
    static final class ValueSpliterator<V> extends HashMapSpliterator<V>
            implements Spliterator<V> {
        ValueSpliterator(InlineStringHashMap<V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class EntrySpliterator<V> extends HashMapSpliterator<V>
                implements Spliterator<Map.Entry<InlineString.ref,V>> {
        EntrySpliterator(InlineStringHashMap<V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
        ...
        public void forEachRemaining(Consumer<? super Map.Entry<InlineString.ref,V>> action) {
            int i, hi, mc;
            if (action == null)
                throw new NullPointerException();
            InlineStringHashMap<V> m = map;
        ...
        public boolean tryAdvance(Consumer<? super Map.Entry<InlineString.ref,V>> action) {
            int hi;
            if (action == null)
                throw new NullPointerException();
            Node<V>[] tab = map.table;
    ...
    Node<V> newNode(int hash, InlineString key, V value, Node<V> next) {
    ...
    TreeNode<V> newTreeNode(int hash, InlineString key, V value, Node<V> next) {
    ...
    static final class TreeNode<V> extends Node<V> {
        ...
        boolean red;
        TreeNode(int hash, InlineString key, V val, Node<V> next) {
        ...
        static <V> void moveRootToFront(Node<V>[] tab, TreeNode<V> root) {
            ...
            if (root != null && tab != null && (n = tab.length) > 0) {
                ...
                var first = (TreeNode<V>)tab[index];
                if (root != first) {
                    Node<V> rn;
                    tab[index] = root;
         ...
         * comparing keys.
         */
        final TreeNode<V> find(int h, InlineString k, Class<?> kc) {
            TreeNode<V> p = this;
            do {
                int ph, dir; InlineString pk;
                TreeNode<V> pl = p.left, pr = p.right, q;
                if ((ph = p.hash) > h)
                    p = pl;
                else if (ph < h)
                    p = pr;
                else if ((pk = p.key).equals(k))
                    return p;
                else if (pl == null)
                    p = pr;
                else if (pr == null)
         ...
         */
        final TreeNode<V> getTreeNode(int h, InlineString k) {
         ...
         */
        static int tieBreakOrder(InlineString a, InlineString b) {
            int d = (System.identityHashCode(a) <= System.identityHashCode(b) ?
                        -1 : 1);
            return d;
        }
        ...
        final void treeify(Node<V>[] tab) {
            ...
            for (TreeNode<V> x = this, next; x != null; x = next) {
                ...
                if (root == null) {
                    ...
                    InlineString k = x.key;
                    int h = x.hash;
                    Class<?> kc = null;
                    for (TreeNode<V> p = root;;) {
                        int dir, ph;
                        InlineString pk = p.key;
                        if ((ph = p.hash) > h)
                            dir = -1;
                        else if (ph < h)
                            dir = 1;
         ...
         * this node.
         */
        final Node<V> untreeify(InlineStringHashMap<V> map) {
         ...
         */
        final TreeNode<V> putTreeVal(InlineStringHashMap<V> map, Node<V>[] tab,
                                     int h, InlineString k, V v) {
            Class<?> kc = null;
            boolean searched = false;
            TreeNode<V> root = (parent != null) ? root() : this;
            for (TreeNode<V> p = root;;) {
                int dir, ph; InlineString pk;
                if ((ph = p.hash) > h)
                    dir = -1;
                else if (ph < h)
                    dir = 1;
         ...
         */
        final void removeTreeNode(InlineStringHashMap<V> map, Node<V>[] tab,
                                  boolean movable) {
            int n;
         ...
         */
        final void split(InlineStringHashMap<V> map, Node<V>[] tab, int index, int bit) {
            TreeNode<V> b = this;
